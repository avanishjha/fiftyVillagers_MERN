        ...
        if (check.rows.length > 0) {
            ...
            const updateQuery = `
                ...
                SET father_name = $1, father_occupation = $2, family_members = $3, dob = $4, gender = $5, 
                    ...
                    id_proof_url = $15, exam_category = $16, special_condition = $17,
            ...
            const updated = await pool.query(updateQuery, [
                ...
                id_proof_url, exam_category, special_condition,
            ...
            const newApp = await pool.query(insertQuery, [
                ...
                special_condition, status || 'pending'
            ]);
